...
Use **Import data** to restore a previous dashboard backup. Importing replaces the current browser's saved dashboard data after confirmation, and the app rejects JSON files that are not labeled as Daily Dev Dashboard backups.
